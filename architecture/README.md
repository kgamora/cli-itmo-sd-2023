...
5. Конкатинация строк, после подстановки. Затем происходит разбиение входной строки с помощью `Lexer`. Если `Lexer` успешно обработал строку то переходим к следующему пункту, иначе выводим ошибку и переходим к пункту 1.
